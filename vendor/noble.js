// Vendored, pinned, no CDN. Rebuild: node tools/build.mjs
//   @noble/curves@2.4.0
//   @noble/hashes@2.4.0
...
// tools/node_modules/@noble/hashes/_blake.js
...
// tools/node_modules/@noble/hashes/blake2.js
...
var blake2b = /* @__PURE__ */ createHasher((opts2) => new _BLAKE2b(opts2));

// tools/node_modules/@noble/hashes/argon2.js
...
function argon2InitialHash(password, salt, type, opts2) {
  const ownedInputs = [];
...
function argon2Init(password, salt, type, opts2) {
  const { H0, p, dkLen, m, t, version, maxmem, onProgress, asyncTick } = argon2InitialHash(password, salt, type, opts2);
  try {
    const lanes = p;
...
function argon2(type, password, salt, opts2) {
...
var argon2id = (password, salt, opts2 = {}) => argon2(AT.Argon2id, password, salt, opts2);
...
// tools/node_modules/@noble/hashes/hkdf.js
...
// tools/node_modules/@noble/hashes/pbkdf2.js
...
var SHA2_32B = class extends HashMD {
  ...
  get() {
    const { A, B: B2, C, D, E, F: F2, G: G2, H } = this;
    return [A, B2, C, D, E, F2, G2, H];
  }
  // prettier-ignore
  set(A, B2, C, D, E, F2, G2, H) {
    this.A = A | 0;
    this.B = B2 | 0;
    this.C = C | 0;
    this.D = D | 0;
  ...
  process(view, offset) {
    ...
    let { A, B: B2, C, D, E, F: F2, G: G2, H } = this;
    for (let i = 0; i < 64; i++) {
...
// tools/node_modules/@noble/curves/abstract/edwards.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
// tools/node_modules/@noble/curves/abstract/fft.js
...
// tools/node_modules/@noble/curves/abstract/montgomery.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function montgomery(curveDef) {
  ...
  function decodeScalar(scalar) {
    return bytesToNumberLE(adjustScalarBytes2(copyBytes2(abytes2(scalar, fieldLen, "scalar"))));
  }
...
// tools/node_modules/@noble/curves/ed25519.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
// tools/node_modules/@noble/post-quantum/utils.js
...
// tools/node_modules/@noble/post-quantum/_crystals.js
/*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */
...
// tools/node_modules/@noble/post-quantum/ml-kem.js
/*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */
var N = 256;
var Q = 3329;
var F = 3303;
...
// tools/node_modules/@scure/bip39/wordlists/english.js
